...
use App\Http\Requests\UpdateTeacherStudentRequest;
...
class TeacherStudentController extends Controller
{
    ...
    public function update(UpdateTeacherStudentRequest $request, $id): JsonResponse
    {
        $student = User::query()->find($id);

        // Check if the user exists and has the 'student' role
        if (!$student || !$student->hasRole('student')) {
            return response()->json(['error' => 'Not found or user does not have the student role'], 404);
        }
